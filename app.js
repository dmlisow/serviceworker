...
function setNotificationDemoBody() {
    if (input_body.val().search(/^It's found today at \d\d:\d\d$/i) !== -1) {
        var now = new Date();
        input_body.val('Поступил новый заказ в' + now.getHours() + ':' + addZero(now.getMinutes()));
    } else {
...
function sendNotification(notification) {
    var key = 'AAAA5u6xKw4:APA91bFQ-AKUVsbVqAkIEoUnok9oeNlZeQVRq43JeHD_pRHgjm5i2vN1DY-nGo4eH93OI4vxs8Ao4kUyr_-beT-N5usj_MlFQ1sxzB5r-D8UP5478UlsAv_xCis4jblGmlfJbeaUQPdC';
